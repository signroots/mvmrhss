...
const facilities = [
  ...
  },
  {
    ...
    description: `The school provides bus service facilities to pick up and drop students at designated locations.`,
  ...
  {
    title: "HOSTEL",
    description: `Separate hostels for both boys and girls are functioning in the campus.`,
    image: "/assets/img/facilities/hostelimg.jpg",
  },
  {
    title: "UNIFORM",
    description: `Students are required to wear the prescribed school uniform that represents discipline and unity.`,
    image: "/assets/img/facilities/uniformimg.jpg",
  },
  {
    title: "SCHOOL STORE",
    description: `The school maintains a full-fledged store for students.`,
