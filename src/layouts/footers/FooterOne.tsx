...
const FooterOne = ({ style_2 }: any) => {
  return (
    <footer className={`it-footer ${style_2 ? 'it-footer__red-color' : ''}`}>
      {/* Footer Area */}
      <div className="it-footer__area it-footer__space z-index">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 mb-30">
              <div className="it-footer__widget footer-col-1">
                ...
                <div className="it-footer__text pb-15">
                  <p>
                    M.V.M.R.H.S.S – Quality education for all, from K.G. to Higher
                    Secondary
                  </p>
                </div>
              </div>
                ...
                <div className="it-footer__gallery-box">
                  <div className="it-footer__gallery d-flex align-items-center">
                    ...
                    <div className="it-footer__gallery-content">
                      <span className={`${style_2 ? 'color-red' : ''}`}>
                        <i className="far fa-clock"></i> Admission
                      </span>
                  ...
                  <div className="it-footer__gallery d-flex align-items-center">
                    ...
                    <div className="it-footer__gallery-content">
                      <span className={`${style_2 ? 'color-red' : ''}`}>
                        <i className="far fa-clock"></i> Facilities
                      </span>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 mb-30">
              <div className="it-footer__widget footer-col-4">
                ...
                <div className="it-footer__social flex space-x-4">
                  <a href="#" className="text-orange-500"><i className="fa-brands fa-facebook-f"></i></a>
                  <a href="#" className="text-orange-500"><i className="fa-brands fa-instagram"></i></a>
                  <a href="#" className="text-orange-500"><i className="fa-brands fa-linkedin-in"></i></a>
                  <a href="#" className="text-orange-500"><i className="fa-brands fa-twitter"></i></a>
                </div>
              </div>
            </div>
      ...
      {/* Copyright */}
      <div className={`it-copyright__area ${style_2 ? 'it-copyright__black-bg' : 'it-copyright__bg'}`}>
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="it-copyright__text text-center">
                <span>
                  ...
                  <a href="https://signroots.com/" target="_blank" rel="noopener noreferrer">
                    signrOots
                  </a>
                </span>
              </div>
